...
class SignUpInfoViewModel(navController: NavController,var context: Context) : BaseViewModel(navController){
...
//            navController.navigate(R.id.action_signUpInfoFragment_to_phoneCertification,bundle)
